...
if __name__ == '__main__':
    ...
    '''))
parser.add_argument("-c", "--command", action="store_true", help="Execute Command, see --help for more info.")
parser.add_argument("-e", "--execute", help="Execute specified command. See --help for more info.")
parser.add_argument("-l", "--listen", action="store_true", help="Activate listener, see --help for more info.")
parser.add_argument("-p", "--port", type=int, default=5555, help="Specify port, see --help for more info.")
parser.add_argument("-t", "--target", default="192.168.1.108", help="Specify IP Address, see --help for more info.")
parser.add_argument("-u", "--upload", help="Upload file, see --help for more info.")
